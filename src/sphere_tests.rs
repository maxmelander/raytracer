...
fn normal_point_x_axis() {
    let s = Sphere::new();
    let n = s.local_normal_at(Tuple::new_point(1., 0., 0.)).unwrap();
...
fn normal_point_y_axis() {
    let s = Sphere::new();
    let n = s.local_normal_at(Tuple::new_point(0., 1., 0.)).unwrap();
...
fn normal_point_z_axis() {
    let s = Sphere::new();
    let n = s.local_normal_at(Tuple::new_point(0., 0., 1.)).unwrap();
...
fn normal_point_non_axial() {
    let s = Sphere::new();
    let n = s.local_normal_at(Tuple::new_point(3_f64.sqrt() / 3., 3_f64.sqrt() / 3., 3_f64.sqrt() / 3.)).unwrap();
...
fn normal_translated_sphere() {
    ...
    let n = s.local_normal_at(Tuple::new_point(0., 1.70711, -0.70711)).unwrap();
...
fn normal_transformed_sphere() {
    ...
    let n = s.local_normal_at(Tuple::new_point(0., 2_f64.sqrt() / 2., -2_f64.sqrt() / 2.)).unwrap();
